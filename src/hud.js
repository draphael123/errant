...
export class HUD {
  constructor() {
    ...
    this.vignette = document.getElementById('vignette'); this.staminaWrap = document.getElementById('stamina-wrap'); this.dashFill = document.getElementById('dashfill'); this.lowhp = document.getElementById('lowhp'); this.lockhint = document.getElementById('lockhint');
  ...
  setDash(frac) { if (this.dashFill) { this.dashFill.style.width = Math.round(frac * 100) + '%'; this.dashFill.classList.toggle('ready', frac >= 1); } }
