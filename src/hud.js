...
export class HUD {
  constructor() {
    ...
    this.vignette = document.getElementById('vignette'); this.lowhp = document.getElementById('lowhp'); this.lockhint = document.getElementById('lockhint');
  ...
  setStamina(frac, low) { const v = Math.round(frac * 100); if (v !== this._sta) { this._sta = v; this.stamina.style.width = v + '%'; } this.stamina.classList.toggle('low', !!low); }
