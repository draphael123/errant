...
export const SCHEMA = [
  ...
  { key: 'sound', label: 'Sound source', type: 'select', options: [['files', 'Recorded (CC0 files)'], ['synth', 'Synthesised']], def: 'files' },
  { key: 'musicSource', label: 'Music source', type: 'select', options: [['files', 'Recorded tracks'], ['synth', 'Synthesised'], ['off', 'Off']], def: 'files', hint: 'Use this to isolate a noise: switch to Off, then Synth' },
  { key: 'ambience', label: 'Forest ambience', type: 'toggle', def: true },
  { group: 'Camera' },
  ...
  { key: 'enemyBars', label: 'Enemy health bars', type: 'toggle', def: true },
  { key: 'numbers', label: 'Damage numbers', type: 'toggle', def: true },
  { key: 'mist', label: 'Ravine mist', type: 'toggle', def: true },
  { group: 'Performance' },
  { key: 'fps', label: 'Frame counter', type: 'toggle', def: false, hint: 'FPS, frame time and draw calls · F3 for detail' },
  { key: 'dpr', label: 'Pixel density cap', type: 'select', options: [['1', '1× (fastest)'], ['1.5', '1.5×'], ['2', '2× (sharpest)']], def: '1.5', hint: 'High-DPI screens render many more pixels' },
  ...
  { key: 'farEnemies', label: 'Simulate distant enemies', type: 'toggle', def: false, hint: 'Off skips goblins more than 75 m away' },
